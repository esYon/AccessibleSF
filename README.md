...
##How we built it
* We created user stories, wireframes, and our git workflow up front.
* We split into front end and back end teams. Everyone took on new learning challenges.
* We determined inputs and outputs to be passed between the teams.
* We researched APIs and sites for GoogleMaps, NextBus, Muni and BART.
* We attempted to put it all together. * We continued to re-evaluate and modify our MVP throughout.
